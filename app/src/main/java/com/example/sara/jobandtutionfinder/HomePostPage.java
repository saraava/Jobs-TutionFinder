...
public class HomePostPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_post_page);
    ...
    void saveInfo(){
        ...
        PostInformation4 post=new PostInformation4(f1.getText().toString().trim(),user,postRandomName.toString());
