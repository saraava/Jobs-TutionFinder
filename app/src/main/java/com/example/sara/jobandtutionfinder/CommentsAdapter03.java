...
public class CommentsAdapter03 extends BaseAdapter {

    private Context activity;
    private ArrayList<comment03class> allstudent=new ArrayList<>();
    ...
    public CommentsAdapter03(Context activity,ArrayList<comment03class> allstudent) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            view = layoutInflater.inflate(R.layout.coaching_comment_show,null);
        ...
        viewHolder.timee.setText("Commented on "+allstudent.get(pos).getDatee()+ " "+allstudent.get(pos).getTimee());
